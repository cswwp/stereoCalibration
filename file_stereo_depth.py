...
if __name__ == '__main__':
    ...
    #parser.add_argument('--is_real_time', type=int, required=True, help='Is it camera stream or video', default=2)
    ...
    # cap_right.set(cv2.CAP_PROP_FRAME_WIDTH, 960)  # float
    # cap_right.set(cv2.CAP_PROP_FRAME_HEIGHT, 540)  # float
    #
    # cap_left.set(cv2.CAP_PROP_FRAME_WIDTH, 960)  # float
    # cap_left.set(cv2.CAP_PROP_FRAME_HEIGHT, 540)  # float
